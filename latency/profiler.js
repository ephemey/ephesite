...
__Profiler.prototype.cssReset = 'font-size:12px;line-height:1em;z-index:99999;text-align:left;' +
  ...
  'shadow:none;display:inline-block;color:#000;font-' +
...
__Profiler.prototype.elementCss = 'position:fixed;margin:0 auto;top:' +
  '0;left:0;right:0;border-bottom:solid 1px #ffffff;box-shadow:0 2px 5px rgba(0,0,0,.1);';

__Profiler.prototype.containerCss = 'background:#FFFFFF;background:rgba(255,255,255,.99);padding:20px;display:block;';
...
__Profiler.prototype.infoLinkCss = 'color:#ffffff;margin:1em 0 0 0;';
...
__Profiler.prototype._createHeader = function() {
  ...
  h.innerHTML = 'Latency ' + sectionStr;
